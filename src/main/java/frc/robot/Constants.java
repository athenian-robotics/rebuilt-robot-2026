...
public class Constants {
  ...
  public final class DriveCommandsConstants {
    ...
    public static final double ANGLE_MAX_VELOCITY = 0.5;
    public static final double ANGLE_MAX_ACCELERATION = 1;
  ...
  public final class OuttakeConstants {
    ...
    public static final double CALCULATE_ANGLE_TRENDLINE_COEF_A = -4.5; // was -3.98
    public static final double CALCULATE_ANGLE_TRENDLINE_COEF_B = 14; // was 14.9
